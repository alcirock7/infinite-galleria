...
function goToCheckout(event, artId) {
    ...
    const checkoutLinks = {
        ...
        'art4': {
            'standard': 'https://infinite-galleria.lemonsqueezy.com/checkout/buy/b4534f67-351b-40c1-b99e-97d430d4ce42?discount=0',
            'extended': 'https://infinite-galleria.lemonsqueezy.com/checkout/buy/b4534f67-351b-40c1-b99e-97d430d4ce42?discount=0',
            'exclusive': 'https://infinite-galleria.lemonsqueezy.com/checkout/buy/b4534f67-351b-40c1-b99e-97d430d4ce42?discount=0'
        },
        'art5': {
            'standard': 'https://infinite-galleria.lemonsqueezy.com/checkout/buy/d23a29de-e684-48e8-8993-749089bdc644?discount=0',
            'extended': 'https://infinite-galleria.lemonsqueezy.com/checkout/buy/d23a29de-e684-48e8-8993-749089bdc644?discount=0',
            'exclusive': 'https://infinite-galleria.lemonsqueezy.com/checkout/buy/d23a29de-e684-48e8-8993-749089bdc644?discount=0'
        },
        'art6': {
        ...
        'art8': {
            'standard': 'https://infinite-galleria.lemonsqueezy.com/checkout/buy/3506b9fe-6496-452a-862b-6b368695e4ac?discount=0',
            'extended': 'https://infinite-galleria.lemonsqueezy.com/checkout/buy/3506b9fe-6496-452a-862b-6b368695e4ac?discount=0',
            'exclusive': 'https://infinite-galleria.lemonsqueezy.com/checkout/buy/3506b9fe-6496-452a-862b-6b368695e4ac?discount=0'
        },
        'art9': {
